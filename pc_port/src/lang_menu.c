...
static const s_MenuTranslation s_MenuTr[] = {
    ...
    { "LOAD",     { "LADEN",  "CHARGER",   "CARGAR",    "CARICA"    }, "\x33\x41\x44\x51\x54\x33\x49\x53\x4A" },
    { "CONTINUE", { "WEITER", "CONTINUER", "CONTINUAR", "CONTINUA"  }, "\x50\x51\x4F\x45\x4F\x4C\x47\x49\x53\x4A" },
    { "START",    { NULL,     "COMMENCER", "EMPEZAR",   "INIZIA"    }, "\x4E\x41\x58\x41\x53\x4A" },
    ...
    { "\x01W\x01a\x01l\x01k/R\x01\x01u\x01n_\x01\x01\x01\x01" "Co\x01n\x01t\x01ro\x01l",
                        ...
                        "\x56\x4F\x45\x77\x42\x41\x2F\x42\x46\x44" },
    ...
    { "Next_Page",         { "N\xE4" "chste_Seite", "Page_suivante",      "Sig._p\xE1gina",     "Pagina_succ."   }, "\x52\x4C\x46\x45\x5F\x52\x53\x51\x41\x4E\x49\x57\x41" },
    { "Prev_Page",         { "Vorherige_Seite",    "Page_pr\xE9" "c.",    "P\xE1gina_ant.",     "Pagina_prec."   }, "\x50\x51\x46\x45\x5F\x52\x53\x51\x41\x4E\x49\x57\x41" },
    ...
    { "First_Person_FOV",  { "Ego-FOV",            "FOV_1re_pers.",       "FOV_1ra_pers.",      "FOV_1a_pers."   }, "\x46\x4F\x56\x5F\x4F\x53\x5F\x31\x5F\x4C\x49\x57\x41" },
    { "Mouse_Sensitivity", { "Maus-Sensibilit\xE4t", "Sensib._souris",    "Sensib._rat\xF3n",   "Sensib._mouse"  }, "\x58\x54\x43\x52\x53\x43\x5F\x4D\x5B\x59\x49" },
    { "Pad_Sensitivity",   { "Pad-Sensibilit\xE4t", "Sensib._manette",    "Sensib._mando",      "Sensib._pad"    }, "\x58\x54\x43\x52\x53\x43\x5F\x44\x46\x4A\x4D\x50\x41\x45\x41" },
    ...
    { "Filmic",            { "Filmisch",           "Filmique",            "F\xEDlmico",         "Filmico"        }, "\x55\x49\x4C\x4D\x49\x4B" },
